...
export const Bot = (botProps: BotProps & { class?: string }) => {
  ...
  const [speakFunction, setSpeakFunction] = createSignal<((text: string) => void) | null>(null);
  ...
  return (
    <>
      ...
      >
        ...
        <div
          ref={videoContainer}
          class="w-full flex justify-center items-center overflow-visible"
          style={{
        ...
        >
          <InteractiveAvatar 
            ...
            avatarName={props.interactiveAvatar?.avatarName}
            voiceId={props.interactiveAvatar?.voice?.voiceId}
          />
        </div>
        {/* Title bar */}
        {props.showTitle ? (
          <div
            class="flex flex-row items-center w-full h-[50px] z-10"
            style={{
        ...
        <div class="flex flex-col w-full flex-grow justify-start z-0 overflow-hidden">
          <div
            ref={chatContainer}
            class="overflow-y-auto flex-grow min-w-full w-full px-3 relative scrollable-container chatbot-chat-view scroll-smooth"
          >
            <For each={[...messages()]}>
              {(message, index) => {
                return (
                  <>
                    ...
                    {message.type === 'apiMessage' && (
                      <BotBubble
                        ...
                        interactiveAvatar={props.interactiveAvatar}
                        chatflowid={props.chatflowid}
                        chatId={chatId()}
                        apiHost={props.apiHost}
